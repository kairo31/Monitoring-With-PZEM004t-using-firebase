...
def main() -> None:
    print("🔌 Inisialisasi Firebase untuk retrain RL...")
    initialize_firebase()

    print("📥 Menyiapkan dataset RL dari history Firebase...")
    ...
    print(f"🤖 Training PPO dimulai | steps={TOTAL_TIMESTEPS} | samples={len(rows)}")
    model.learn(total_timesteps=TOTAL_TIMESTEPS)

    MODEL_OUTPUT_PATH.parent.mkdir(parents=True, exist_ok=True)
    model.save(str(MODEL_OUTPUT_PATH))

    print(f"✅ Model RL baru tersimpan di: {MODEL_OUTPUT_PATH}")
